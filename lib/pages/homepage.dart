...
class _HomePageState extends State<HomePage> {
  ...
  expenseData.sort((a, b) => a.date.day.compareTo(b.date.day));
  incomeData.sort((a, b) => a.date.day.compareTo(b.date.day));

  // Create spots for both income and expense
  for (var i = 0; i < expenseData.length; i++) {
    dataSet.add(
      FlSpot(
        expenseData[i].date.day.toDouble(),
        expenseData[i].amount.toDouble(),
      ),
    );
  }
  for (var i = 0; i < incomeData.length; i++) {
    dataSet.add(
      FlSpot(
        incomeData[i].date.day.toDouble(),
        incomeData[i].amount.toDouble(),
      ),
    );
  }
